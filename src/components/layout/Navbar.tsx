...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-white/6 bg-black/60 backdrop-blur-xl">
      <div className="flex min-w-0 items-center justify-between gap-2 px-4 py-2.5 sm:px-6">
        ...
        <span className="hidden min-[360px]:inline text-sm font-bold tracking-wide text-foreground lg:hidden">
