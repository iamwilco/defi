...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-accent-blue/20 bg-linear-to-br from-black via-[#050510] to-[#0a0a20] p-6 sm:p-10 lg:overflow-visible">
      ...
      <div className="relative z-10 flex flex-col items-start gap-8 lg:flex-row lg:items-center lg:gap-12">
        <div className="relative z-10 flex-1">
          ...
          <FadeIn delay={0.1}>
            <h1 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
              USDM DeFi Coalition:
              <span className="mt-1 block text-accent-blue glow-blue-text">Building Real Growth Together</span>
            </h1>
          </FadeIn>

          <FadeIn delay={0.2}>
            <p className="mt-4 max-w-lg text-sm leading-relaxed text-(--text-secondary)">
              We&apos;re a group of passionate teams from NBX, Fluid, and more, pooling resources to make
              USDM truly useful on Cardano. Think easy lending, smart incentives, and guides that help
              real users like you get started fast.
            </p>
          </FadeIn>
        ...
        {/* 3D Globe */}
        <div className="relative z-80 hidden h-72 w-72 shrink-0 overflow-visible lg:block xl:h-80 xl:w-80">
